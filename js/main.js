...
"use strict";
__webpack_require__.r(__webpack_exports__);
let valueDisplays = document.querySelectorAll('.numbers-wrapper-item__indicators');
let interval = 80000;
function startAnimationOnScroll(scrollTriggerElement) {
  let triggerOffset = scrollTriggerElement.getBoundingClientRect().top + window.pageYOffset;
  let isTriggered = false;
  function startAnimation() {
    if (!isTriggered && window.pageYOffset + window.innerHeight > triggerOffset) {
...
const swiperCase = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](dealsSlider, {
  slidesPerView: '5',
  loop: true,
  spaceBetween: 20,
  pagination: {
